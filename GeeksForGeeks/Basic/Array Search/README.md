...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/search-an-element-in-an-array-1587115621/1)

## Solved On
30 Jul 2026 at 09:48 am

<h2><a href="https://www.geeksforgeeks.org/problems/search-an-element-in-an-array-1587115621/1">Array Search</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 14pt;">Given an array, <strong>arr[]</strong> of n integers, and an integer element <strong>x</strong>, find whether element x is present in the array. Return the index of the first occurrence of x in the array, or -1 if it doesn't exist.</span></p>
