...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/odd-or-even3618/1?)

## Solved On
17 Aug 2026 at 11:02 am

<h2><a href="https://www.geeksforgeeks.org/problems/odd-or-even3618/1?">Odd or Even</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 18px;">Given a positive integer <strong>n</strong>, determine whether it is odd or even. Return </span><span style="font-size: 18px;"><strong>true </strong>if the number is even and <strong>false </strong>if the number is odd.</span></p>
