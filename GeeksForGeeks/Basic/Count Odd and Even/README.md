...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/count-odd-even/1)

## Solved On
30 Jul 2026 at 09:58 am

<h2><a href="https://www.geeksforgeeks.org/problems/count-odd-even/1">Count Odd and Even</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 14pt;">Given an array <strong>arr[] </strong>of positive integers. The task is to return the count of the number of <strong>odd </strong>and <strong>even&nbsp;</strong>elements in the array.</span></p>
...
<p><span style="font-size: 14pt;"><strong>Constraints:</strong><br>1 &lt;= arr.size &lt;= 10<sup>6</sup><br>1 &lt;= arr[i] &lt;= 10<sup>6</sup></span></p>