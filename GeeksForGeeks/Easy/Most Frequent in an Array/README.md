...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/most-frequent-element-in-an-array/1)

## Solved On
10 Aug 2026 at 08:23 am

<h2><a href="https://www.geeksforgeeks.org/problems/most-frequent-element-in-an-array/1">Most Frequent in an Array</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 14pt;">You are given an integer array <strong>arr[]</strong>. You need to return the element which <strong>occurs maximum times</strong> in <strong>arr[]</strong>.</span><br><span style="font-size: 14pt;"><strong>Note:</strong> If multiple such elements exists return the <strong>maximum</strong> element.</span></p>
...
<p><span style="font-size: 14pt;"><strong>Constraints:</strong><strong><br></strong>1 ≤ arr.size() ≤ 10<sup>5</sup></span><br><span style="font-size: 14pt;">-10<sup>5 </sup>≤ arr[i] ≤ 10<sup>5</sup></span></p>