...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/find-the-smallest-and-second-smallest-element-in-an-array3226/1)

## Solved On
22 Aug 2026 at 07:28 pm

<h2><a href="https://www.geeksforgeeks.org/problems/find-the-smallest-and-second-smallest-element-in-an-array3226/1">First and Second Smallests</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 14pt;">Given an array, <strong>arr[]</strong> of integers, your task is to return the <strong>smallest</strong> and <strong>second smallest</strong> element in the array. If the smallest and second smallest do not exist, return <strong style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">-1.</strong></span></p>
